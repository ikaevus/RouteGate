...
classify_journals() {
  local agent_journal manager_journal agent_processes agent_pid agent_restarts last_failure last_failure_class last_presence_failure last_presence_failure_class
  ...
  log "client-presence failures=$(count_matches "$agent_journal" 'report client presence failed') last-class=${last_presence_failure_class:-none} accepted-reports=$(count_matches "$agent_journal" 'client presence report accepted')"
